...
const CreateCourseDialog: FunctionComponent<CreateCourseDialogProps> = ({ onCourseCreated, isOpen, onClose }) => {
    ...
    return (
        ...
        <DialogHeader>
          ...
          <Button onClick={handleCreateCourse} loading={loading} colorScheme="teal">Create</Button>
          </DialogFooter>
        </DialogContent>
      </DialogRoot>
    );
